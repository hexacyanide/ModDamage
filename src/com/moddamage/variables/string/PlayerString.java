...
public class PlayerString extends StringExp<Player> {
    ...
    public enum PlayerStringProperty {
        ...
        {
            @Override
            protected String getString(Player player) {
        ...
        WIELDING
        {
            ...
            protected String getString(Player player)
            {
                return MAINHAND_WIELDING.getString(player) + " " + OFFHAND_WIELDING.getString(player);
            }
        },
        MAINHAND_WIELDING
        {
        ...
        OFFHAND_WIELDING
        {
            @Override
            protected String getString(Player player) {
                return player.getInventory().getItemInOffHand().getType().name();
            }
        },
        ENCHANTMENTS
        {
        ...
        HELD_ENCHANTMENTS
        {
            @Override
            protected String getString(Player player) {
                return MAINHAND_ENCHANTMENTS.getString(player) + " " + OFFHAND_ENCHANTMENTS.getString(player);
            }
        },
        MAINHAND_ENCHANTMENTS
        {
            @Override
            protected String getString(Player player) {
                return player.getInventory().getItemInMainHand().getEnchantments().toString();
            }
        },
        OFFHAND_ENCHANTMENTS
        {
            @Override
            protected String getString(Player player) {
                return player.getInventory().getItemInOffHand().getEnchantments().toString();
            }
        },
        ARMOR_ENCHANTMENTS
        {
